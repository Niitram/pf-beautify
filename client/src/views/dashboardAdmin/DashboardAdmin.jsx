...
import { getProductosMinMaxPrecio,getStaticsAppointments, getProductsByCategories}from '../../request/homeDashboard'
...
const DashboardAdmin = ()=>{
  ...
  const labelAppointments = staticAppointments ? Object.keys(staticAppointments) : [];
...
<div className={styles.admin_container}>
 ...
 <div className={styles.statics}> <CardChart title="Statics Products" labels={labelProducts} data={dataProducts} /> </div>
 <div className={styles.statics}>
          <CardChart title="Appointment Statistics" labels={labelAppointments} data={dataAppointments} />
        </div>
        <div className={styles.statics}>
          <CardChart title="Product Categories" labels={labelProductCategories} data={dataProductCategories} />
        </div>
