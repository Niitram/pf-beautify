...
export default function FormCreateService({creationInfo,setCreationInfo,errors,setErrors}){
        ...
        <div className={styles.container}>
            <form  className={styles.containerForm}>
                ...
                >
                    ...
                    <ErrorInputMessage errors={errors?.description} text={errors?.description}/>
                <input
                    type='number'
                    name='price'
                ...
                setErrors={setErrors}
                />
                    <ErrorInputMessage errors={errors?.imageService} text={errors?.imageService}/>
               </form>
                <DragImageServices
