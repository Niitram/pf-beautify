...
import { GET_ALL_PRODUCTS, SEARCH_PRODUCT_BY_NAME, GET_ALL_CATEGORIES, FILTER_PRODUCTS, ORDER_PRODUCTS_BY_PRICE, ORDER_PRODUCTS_BY_RATE } from './actions';
        ...
        case FILTER_PRODUCTS:
            {
                ...
                const filteredCategories = category === "all" ? state.allProducts : state.allProducts.filter(product => product.category === category);

                return {
                    ...state,
                    copyAllProducts: filteredCategories.filter(product => comparePrice(product.price, price))
                }
            }
